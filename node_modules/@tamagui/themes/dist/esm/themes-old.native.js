...
import { colorTokens, darkColors, lightColors } from "./tokens.native.js";
var lightTransparent = "rgba(255,255,255,0)",
  ...
  [lightColorThemes, darkColorThemes] = [colorTokens.light, colorTokens.dark].map(function (colorSet, i) {
    var isLight = i === 0,
  ...
  allThemes = addChildren(baseThemes, function (name, theme) {
    var isLight = name === "light",
      ...
      allColorThemes = addChildren(colorThemes, function (colorName, colorTheme) {
