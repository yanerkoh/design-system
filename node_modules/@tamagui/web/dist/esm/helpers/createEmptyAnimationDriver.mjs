const noAnimationDriver = method => {
    throw new Error(`No animation driver configured. To use ${method}, you must pass \`animations\` to createTamagui. See: https://tamagui.dev/docs/core/animations`);
  },
...
export { createEmptyAnimationDriver };
//# sourceMappingURL=createEmptyAnimationDriver.mjs.map
