...
const useComponentState = (props, animationDriver, staticConfig, config) => {
  const isHydrated = useDidFinishSSR(), needsHydration = !useIsClientOnly(), useAnimations = animationDriver?.useAnimations, { isHOC } = staticConfig, stateRef = useRef(
  ...
  if (!isHydrated)
    ...
    (isAnimatedAndHydrated || isDisabledManually || isClassNameDisabled) && (noClass = !0, process.env.NODE_ENV === "development" && props.debug === "verbose" && log("avoiding className", {
