...
const ACCORDION_NAME = "Accordion", ACCORDION_KEYS = ["Home", "End", "ArrowDown", "ArrowUp", "ArrowLeft", "ArrowRight"], [Collection, useCollection] = createCollection(ACCORDION_NAME), ACCORDION_CONTEXT = "Accordion", AccordionComponent = React.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsx(Collection.Provider, { scope: props.__scopeAccordion || ACCORDION_CONTEXT, children: type === "multiple" ? /* @__PURE__ */ jsx(AccordionImplMultiple, { ...multipleProps, ref: forwardedRef }) : /* @__PURE__ */ jsx(AccordionImplSingle, { ...singleProps, ref: forwardedRef }) });
});
  ...
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsx(
      AccordionImplProvider,
      {
        ...
        direction: dir,
        orientation,
        children: /* @__PURE__ */ jsx(Collection.Slot, { scope: __scopeAccordion || ACCORDION_CONTEXT, children: /* @__PURE__ */ jsx(
          YStack,
          {
...
const AccordionTriggerFrame = styled(Collapsible.Trigger, {
  ...
  return /* @__PURE__ */ jsx(Collection.ItemSlot, { scope: __scopeAccordion || ACCORDION_CONTEXT, children: /* @__PURE__ */ jsx(
